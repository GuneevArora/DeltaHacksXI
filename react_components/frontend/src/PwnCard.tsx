...
function PwnCard({ args, disabled, theme }: ComponentProps): ReactElement {
    ...
    return (
        ...
        <button onClick={() => { Streamlit.setComponentValue(1); setClicked(true); }} className="m-2 p-1 rounded-md w-full bg-red-500 shadow-sm hover:scale-[101%] hover:bg-red-400 active:bg-red-600 ">Inspect Threat</button>
        </div>
    )
}
